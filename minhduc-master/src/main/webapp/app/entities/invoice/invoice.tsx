    ...
    return (
      <div>
        <h2 id="invoice-heading">
          <Translate contentKey="smartorderApp.invoice.home.title">Invoices</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartorderApp.invoice.home.createLabel">Create new Invoice</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('totalPrice')}>
                    <Translate contentKey="smartorderApp.invoice.totalPrice">Total Price</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
