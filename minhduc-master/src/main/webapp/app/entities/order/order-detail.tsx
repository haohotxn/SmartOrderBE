  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="smartorderApp.order.detail.title">Order</Translate> [<b>{orderEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="status">
                <Translate contentKey="smartorderApp.order.status">Status</Translate>
              </span>
            </dt>
