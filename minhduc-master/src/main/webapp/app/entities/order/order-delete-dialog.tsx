...
export class OrderDeleteDialog extends React.Component<IOrderDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.orderEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="smartorderApp.order.delete.question">
          <Translate contentKey="smartorderApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
