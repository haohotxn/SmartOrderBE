...
export class Order extends React.Component<IOrderProps, IOrderState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="order-heading">
          <Translate contentKey="smartorderApp.order.home.title">Orders</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartorderApp.order.home.createLabel">Create new Order</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('status')}>
                    <Translate contentKey="smartorderApp.order.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {orderList.map((order, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`smartorderApp.StatusOrder.${order.status}`} />
                    </td>
